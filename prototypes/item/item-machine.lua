...
local items = {
    ...
    {source = "oil-refinery", name = "oil-refinery-mk2", subgroup = "fb-fluids", order = "c-a", tint = Constant.green_tint, icon_name = "oil-refinery-mk2.png"},
    {source = "oil-refinery", name = "oil-refinery-mk3", subgroup = "fb-fluids", order = "c-b", tint = Constant.blue_tint, icon_name = "oil-refinery-mk3.png"},
    {source = "chemical-plant", name = "chemical-plant-mk2", subgroup = "fb-fluids", order = "d-a", tint = Constant.green_tint, icon_name = "chemical-plant-mk2.png"},
    {source = "chemical-plant", name = "chemical-plant-mk3", subgroup = "fb-fluids", order = "d-b", tint = Constant.blue_tint, icon_name = "chemical-plant-mk3.png"},
